...
Run from the repository root (parent of plotcraft-text-to-python):

  # Using Gemini (e.g. Gemini-3-pro)
  python plotcraft-text-to-python/scripts/generate_synthetic_tikz_to_python.py \\
  ...
  python plotcraft-text-to-python/scripts/generate_synthetic_tikz_to_python.py \\
    --provider gemini --model google/gemini-3-pro \\
    --input cached_data/samples.jsonl --limit 500 \\
    --pyvec-output plotcraft-text-to-python/synthetic_dataset.jsonl
"""
...
def repo_root() -> Path:
    """Repository root = parent of plotcraft-text-to-python (parent of script's parent's parent)."""
    script_dir = Path(__file__).resolve().parent
    # script_dir = .../plotcraft-text-to-python/scripts  -> parent = plotcraft-text-to-python, parent.parent = repo root
