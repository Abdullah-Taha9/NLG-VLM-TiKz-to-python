...
From the **repository root** (parent of `plotcraft-text-to-python`):
...
|-- MINDMAP.txt
|-- scripts/
|   `-- generate_synthetic_tikz_to_python.py
```
...
- `scripts/generate_synthetic_tikz_to_python.py`: TikZ→Python synthetic data generation (see [Synthetic data generation](#synthetic-data-generation))
